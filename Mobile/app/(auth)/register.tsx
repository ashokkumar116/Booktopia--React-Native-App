...
const Register = () => {
    ...
    const handleRegister = async () => {
        const response: boolean | undefined = await register({
            username,
            email: email,
            password: password,
        });
        ...
        >
            <ScrollView showsHorizontalScrollIndicator={false}>
                <View className="items-center mt-10 gap-4">
                    <Text className="text-4xl uppercase text-indigo-800 font-[Poppins-Black]">
                        Register
                    </Text>
                    <Text className="text-indigo-600 font-[Poppins-Medium] justify-center w-[70%] text-center">
